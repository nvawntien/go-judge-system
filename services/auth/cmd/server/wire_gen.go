...
func InitializeApp(cfg *config.Config) (*container.App, error) {
	...
	registerUseCase := auth.NewRegisterUseCaseWithAbuse(userRepository, mailProvider, tokenGenerator, tokenRepository, passwordEncoder, authAbuseLimiter, authAbuseConfig)
	...
	resendVerificationUseCase := auth.NewResendVerificationUseCaseWithAbuse(userRepository, mailProvider, tokenGenerator, tokenRepository, authAbuseLimiter, authAbuseConfig)
	...
	forgotPasswordUseCase := auth.NewForgotPasswordUseCaseWithAbuse(userRepository, tokenRepository, tokenGenerator, mailProvider, authAbuseLimiter, authAbuseConfig)
