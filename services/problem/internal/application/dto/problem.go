...
type CreateProblemRequest struct {
	...
	InputFormat  string              `json:"input_format" binding:"required,min=1"`
	OutputFormat string              `json:"output_format" binding:"required,min=1"`
...
type UpdateProblemRequest struct {
	...
	InputFormat  *string              `json:"input_format,omitempty" binding:"omitempty,min=1"`
	OutputFormat *string              `json:"output_format,omitempty" binding:"omitempty,min=1"`
