...
const READINESS = [
  ...
  },
  {
    ...
    status: 'Partial',
    detail: 'Admin list is available. Detail and rejudge contracts are not implemented by submission-service yet.',
  ...
  },
  {
    ...
    href: '/admin/users',
    status: 'Unavailable',
    detail: 'Only role assignment by known user ID exists. There is no admin users list/detail API.',
