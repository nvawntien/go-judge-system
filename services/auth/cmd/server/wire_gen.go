...
func InitializeApp(cfg *config.Config) (*container.App, error) {
	...
	authHandler := handler.NewAuthHandler(registerHandler, verifyEmailHandler, resendVerificationHandler, loginHandler, logoutHandler, forgotPasswordHandler, resetPasswordHandler)
